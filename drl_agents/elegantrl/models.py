...
MODELS = {"ddpg": AgentDDPG, "td3": AgentTD3, "sac": AgentSAC, "ppo": AgentPPO, "discrete_ppo": AgentDiscretePPO}
OFF_POLICY_MODELS = ["ddpg", "td3", "sac"]
ON_POLICY_MODELS = ["ppo", "discrete_ppo"]
...
class DRLAgent:
    ...
    def train_model(self, model, cwd, total_timesteps=5000):
        ...
        # load agent
        try:
            model.save_or_load_agent(cwd=cwd, if_save=False)
        except BaseException:
    ...
    def DRL_prediction(model_name, cwd, net_dimension, environment):
        ...
        try:
            ...
            # print("state_dim_DRLAgent", state_dim)
